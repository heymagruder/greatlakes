...
{
    $to = "contact@greatlakeshomeinspectors.com";
    $from = $_REQUEST['email'];
    $name = $_REQUEST['name'];
    ...
    $mailsubject = "Great Leakes Contact Us Form";
	...
	$body .= "<tr><td style='border:none;'>Great Leakes Contact Us Form. Please find the details below:</td></tr>";
...
else if(isset($_REQUEST['getinTouch']))
{
    ...
    $mailsubject = "Great Leakes Request A Quote Form";
	...
	$body .= "<tr><td style='border:none;'><strong>Dear Admin,</strong></td></tr>";
	$body .= "<tr><td style='border:none;'>Great Leakes Request A Quote Form. Please find the details below:</td></tr>";
	$body .= "<tr><td style='border:none;'>&nbsp;</td></tr>";
	$body .= "<tr><td style='border:none;'><strong>Name:</strong> {$name}</td></tr>";
	$body .= "<tr><td style='border:none;'><strong>Email:</strong> {$from}</td></tr>";
